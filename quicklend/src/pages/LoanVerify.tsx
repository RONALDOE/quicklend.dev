  ...
  export default function LoanVerify() {
    ...
    useEffect(() => {
      ...
      setIsLoading(false);
      console.log("CALLING_DATE", dataRef.current?.modalidad, dataRef.current?.fecha, dataRef.current?.numCuotas)
      getDates(dataRef.current?.modalidad, dataRef.current?.fecha, dataRef.current?.numCuotas);
            ...
            <div className="grid h-full w-2/3 grid-cols-2   grid-rows-2  gap-4">
              <div className="row-span-2 flex  flex-col items-center justify-center gap-4 whitespace-normal rounded bg-white text-center">
                ...
                <div className="grid w-full grid-cols-1 gap-4 px-8 text-left text-lg  ">
                  ...
                  <div className="flex items-center justify-between">
                  <span className="font-semibold">Fecha de Inicio de Pagos:</span>
                  <span className="italic">
                    {paymentStartDate?.toString()}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="font-semibold">Fecha de Término de Pagos:</span>
                  <span className="italic">
                    {paymentEndDate?.toString()}
                  </span>
                </div>
                </div>
              </div>
              ...
              <div className=" flex h-full flex-col items-center justify-center gap-4 rounded bg-white ">
                ...
                <button className="rounded bg-red-500  px-4 py-2 font-bold text-black  hover:bg-red-600  ">
                  Cancelar Prestamo
                </button>
              </div>
            </div>
