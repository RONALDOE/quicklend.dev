...
BEGIN
    SELECT count(*) as noPagos FROM payments where status !="Pagado" and fechaAPagar = CURDATE();
    SELECT count(*) as pagos FROM payments where status ="Pagado" and fechaAPagar = CURDATE();
